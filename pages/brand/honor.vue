  ...
  meta: [
    {
      ...
      name: 'description',
      content:
        '愛康健作為深圳愛康健口腔醫院，是一家牙科齒科品牌連鎖醫院，專注於口腔醫療，以醫療品質為核心，注重提升醫療技術水準。在口腔學術領域競賽中，我們連年斬獲大獎。我們秉承著「專科 · 專業 · 專注 · 專心」的初心，為廣大患者提供優質的牙科醫療服務。',
    },
    {
      hid: 'Keywords',
      name: 'Keywords',
...
const headerConfig = {
  ...
  bg: '',
  mbImg: 'https://static.cmereye.com/imgs/2024/06/e62305ddc5e9766c.jpg',
  pageName: 'course-new',
  pcText: [],
  mbText: [],
}
