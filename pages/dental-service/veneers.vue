  ...
  meta: [
    {
      ...
      name: 'description',
      content:
        '愛康健提供瓷牙貼片服務,香港熱線: 6933 8128免費預約掛號,羅湖福田深圳灣口岸分店，透過度身訂製的纖薄瓷貼片黏附於牙齒表層，可以改善牙齒的形狀、長度、外觀和顏色，達到美白和整齊的效果。',
    },
    {
      hid: 'Keywords',
      name: 'Keywords',
      content:
        '愛康健 爱康健 CKJ aikangjian 牙科服務 內地牙科 深圳牙科 深圳愛康健口腔醫院 愛康健齒科集團 美容牙科 高階牙科 醫療券 長者醫療券大灣區試點 案例 牙醫 牙医 深圳 羅湖 朱咪咪 掛號收費 牙科價目表 線上預約 瓷貼片 瓷貼片價格 瓷貼片推薦 全瓷牙貼價錢 牙貼片 牙瓷貼片 牙貼面 瓷牙貼片 美白貼片 美白牙齒 愛康健 瓷貼片流程 微笑設計 美容牙科 微笑曲線 黃金比例',
    },
  ],
})

const headerConfig = {
  img: 'https://static.ckjhk.com/ckj-image/5b4d8834c7c6.webp',
  mbImg: 'https://static.ckjhk.com/ckj-image/b1ddb0b73bb4.webp',
  bg: '',
...
const orthodonticsIntroduceData = {
  ...
  pcImg: 'https://static.cmereye.com/imgs/2023/12/6a199d845146908a.webp',
  tabNavName: '全瓷貼片',
  pageName: 'veneers-test',
}
...
const bpData = {
  ...
  lists: [
    {
      title: '齒色不均',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/9b4db5661d8f9992.jpg',
    },
    {
      title: '牙齒染色',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/97be3e34fc593112.jpg',
    },
    {
      title: '長短不齊',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/df7104194d15fe77.jpg',
    },
    {
      title: '大小不一',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/fdd4e6d4bd343b8d.jpg',
    },
    {
      title: '缺角斷裂',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/9c6933385f454501.jpg',
    },
    {
      title: '四環素牙',
      imgUrl: 'https://static.cmereye.com/imgs/2023/12/7ac148fb970bd0a9.jpg',
    },
  ],
}
const stepData = {
  ...
  lists: [
    {
      ...
      name: '術前諮詢',
      context:
        '初步了解口腔狀況，蒐集牙齒資訊，採討客人期望的牙齒型態，並針對微笑曲線進行客製化設計。',
    },
    {
      title: '第2步',
      img: 'https://static.cmereye.com/imgs/2023/12/62871ce11751ca50.webp',
      name: '磨牙印模',
      context: '在保留最多齒質的情況下，適當磨去牙面，以便裝上貼片。',
    },
    {
      title: '第3步',
      ...
      name: '裝貼臨時貼片',
      context:
        '磨牙完成後，會為客人安裝臨時的樹脂材質貼面，不會影響日常生活及美觀。',
    },
    {
      title: '第4步',
      ...
      name: '全瓷貼片安裝',
      context:
        '貼片製作完成後，在客人牙齒上試裝，並確認貼片與牙齒的適合度，例如形狀及顏色是否符合預期，最後將瓷貼片固定在牙面上。',
    },
    {
      title: '第5步',
      ...
      name: '定期追蹤',
      context:
        '安裝瓷貼片後，需按照專科主任的建議，定期覆診以確保貼片維持良好狀態，壽命可長達15年或以上。',
    },
  ],
}
...
const differData = {
  ...
  listDatas: [
    ...
    {
      name: '原理',
      firstText: '磨去牙齒表面0.3至0.5mm厚度，並貼附於牙齒外側面',
      secondText: '牙齒未經打磨，直接貼附於牙齒外側面',
    },
    {
      name: '療程時長',
      firstText: '一星期完成',
...
const careData = {
  ...
  lists: [
    ...
    {
      img: 'https://static.cmereye.com/imgs/2023/12/661abd1dab682391.jpg',
      text: '定期覆診檢查',
    },
  ],
}
const advantageData = {
  ...
  lists: [
    {
      name: '1.輕薄零負擔',
      text: '僅貼附於牙齒表面，厚度為0.3至0.5mm，對咬合的影響微乎其微。',
    },
    {
      name: '2.自然美白效果',
      text: '質地和色澤與自然牙齒相近，耐用且不易變色。',
    },
    {
      name: '3.輕薄零負擔',
      text: '直接改變牙齒形狀，適合輕微齒列不整人士。',
    },
  ],
}
...
const caseLists = [
  {
    ...
    jos: '空姐',
    context:
      '好多同事都做咗瓷貼片，笑得好靚好有自信，睇落好有氣質。所以我都跟住一齊做，效果非常滿意，好多人讚我似明星。',
  },
  {
    ...
    jos: '準新娘',
    context:
      '自細都介意自己門牙牙齒縫過大，為咗迎接婚禮決定做瓷貼片。影婚紗相時可以盡情笑，整個人煥然一新，感覺迎接新生活的開始。',
  },
  {
    ...
    jos: '模特兒兼演員',
    context:
      '經常要出show面對粉絲觀眾，想整體上鏡形象效果更好。做瓷貼片可以微調原本牙齒嘅不足，棚牙更白更整齊。',
  },
]
</script>
  ...
  <div>
    ...
    <div class="pageIn whitebgColor">
      ...
      <div class="advantage">
        ...
        <div class="advantage-in">
          <div class="advantage-in-l">
            <img
              src="https://static.cmereye.com/imgs/2024/01/53516f846e4b5815.jpg"
      ...
      <div class="differ">
        ...
        <div class="differ-lists">
          ...
          >
            ...
            <div v-if="!listDatasItem.isArrayType">
              {{ listDatasItem.firstText }}
            </div>
            <div v-else class="isArrayType">
              <span
                v-for="(textItem, textIndex) in listDatasItem.firstText"
                :key="textIndex"
                >{{ textItem }}</span
              >
            </div>
            ...
            <div v-else class="isArrayType">
              <span
                v-for="(textItem, textIndex) in listDatasItem.secondText"
                :key="textIndex"
                >{{ textItem }}</span
              >
            </div>
      ...
      <div class="care">
        ...
        <div class="care-context">
          在愛康健完成瓷貼片療程後，我們提供三至五年的保修期，具體期限取決於客人所選擇的瓷貼片品牌。
        </div>
      </div>
      <div class="case">
