...
<template>
  <div style="overflow: hidden; width: 100%">
    ...
    <div class="pageIn whitebgColor">
      ...
      <div class="reason">
        ...
        <div class="reason-in">
          ...
          <div class="reason-in-r">
            <div
              class="item"
              v-for="(reasonItem, reasonIndex) in reasonData.reasonLists"
              :key="reasonIndex"
            >
              <div class="item-r">
                <h3>{{ $t(reasonItem.title) }}</h3>
                <p>{{ $t(reasonItem.context) }}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="contrast-table">
            <div class="tableBox tableTab">
              <div class="contrast-table-in">
                <div
                  v-for="(tableTitleItem, tableTitleIndex) in contrastData.table
                    .title"
                  :key="tableTitleIndex"
                >
                  <span v-for="item in tableTitleItem" :key="item">{{
                    item
                  }}</span>
                </div>
              </div>
              ...
              <div class="contrast-table-in">
                <div>
                  ...
                  <div>
                    <span
                      class="td"
                      v-for="(tdItem, tdIndex) in contrastItem1.td"
                      :key="tdIndex"
                      :style="{
                        background: `url(${tdItem.bg})`,
                ...
                <div
                  class="content"
                  v-for="(contentItem, contentIndex) in contrastItem1.content"
                  :key="contentIndex"
                >
                  <div class="content-l" v-if="contentItem.l.length">
                    <div
                      v-for="(contentIn, contentInIndex) in contentItem.l"
                      :key="contentInIndex"
                    >
                      <span>· </span>
                      <span>{{ contentIn }}</span>
                  ...
                  <div class="content-r" v-if="contentItem.r.length">
                    <div
                      v-for="(contentIn, contentInIndex) in contentItem.r"
                      :key="contentInIndex"
                    >
                      <span>· </span>
                      <span>{{ contentIn }}</span>
                  ...
                  <div class="content-c" v-if="contentItem.c.length">
                    <div
                      v-for="(contentIn, contentInIndex) in contentItem.c"
                      :key="contentInIndex"
                    >
                      <span>· </span>
                      <span>{{ contentIn }}</span>
              ...
              <div class="contrast-table-in">
                <div>
                  ...
                  <div>
                    <span
                      class="td"
                      v-for="(tdItem, tdIndex) in contrastItem2.td"
                      :key="tdIndex"
                      :style="{
                        background: `url(${tdItem.bg})`,
                        'background-size': '100% 100%',
                ...
                <div
                  class="content"
                  v-for="(contentItem, contentIndex) in contrastItem2.content"
                  :key="contentIndex"
                >
                  <div class="content-l" v-if="contentItem.l.length">
                    <div
      ...
      <div class="process">
        <div class="dentistryServices-title">
          <div class="dentistryServices-title-in bb">定製流程</div>
        </div>
        <div class="process-in">
          <div
            class="table"
            v-for="(item, index) in processData.lists"
            :key="index"
          >
            <div
              :class="['table-in', item.type]"
              v-for="(dataItem, dataIndex) in item.data"
              :key="dataIndex"
            >
              <div :class="item.type" v-if="item.type === 'text'">
                <div
                  class="context"
                  v-for="(contextItem, contextIndex) in dataItem.context"
                  :key="contextIndex"
                >
                  <p :data-name="contextItem.name">
                    {{ contextItem.text }}
                  </p>
                </div>
              </div>
              <h3 v-else>{{ dataItem.text }}</h3>
            </div>
          </div>
        </div>
      </div>
