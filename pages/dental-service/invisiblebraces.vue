  ...
  meta: [
    {
      ...
      name: 'description',
      content:
        '愛康健隱形矯齒服務減5000元,香港熱線: 6933 8128免費預約掛號,羅湖福田深圳灣口岸分店，採用最新技術與個人化矯齒計劃打造黃金比例臉型',
    },
    {
      hid: 'Keywords',
      name: 'Keywords',
      content:
        '愛康健 爱康健 CKJ aikangjian 牙科服務 內地牙科 深圳牙科 深圳愛康健口腔醫院 愛康健齒科集團 基楚牙科 美容牙科 高階牙科 醫療券 長者醫療券大灣區試點 案例 牙醫 牙医 深圳 羅湖 朱咪咪 掛號 收費 價目表 線上預約 矯齒 箍牙 隱形牙套 矯齒價錢 箍牙價錢 箍牙流程 牙齒擠擁 倒及牙 齙牙 箍牙時間 微笑設計 美容牙科 微笑曲線 黃金比例 隱形牙套 隱形矯正器 牙齒矯正 透明牙套 牙醫推薦',
    },
  ],
})

const headerConfig = {
  img: 'https://statichk.cmermedical.com/ckj/image/2025031110483301.webp',
  mbImg: 'https://statichk.cmermedical.com/ckj/image/2025031110483302.webp',
  bg: '',
...
const orthodonticsIntroduceData = {
  title: '什麼是隱形矯正？',
  content:
    '隱形矯正是一種活動式透明牙箍，透過先進數位科技，模擬出牙齒移動過程，將牙齒逐步推向理想位置。並利用牙箍的機械性力量令牙周組織產生移動，達到矯正的目的。',
  mbImg:
    'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/yu56uutyu.3x1lwnesqh40.jpg',
  pcImg:
    'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/image7895.6do1esh3zu80.jpg',
  tabNavName: '隱形矯正',
  pageName: 'invisalign',
}
...
const problemData = {
  ...
  lists: [
    ...
    {
      Q: '隱形矯正會產生痛楚嗎？',
      A: ' 隱形矯正利用溫和力量移動牙齒，酸軟感較其他矯正療程低。初期戴新牙箍可能感到緊繃，數日後會自然消退。',
    },
  ],
}
...
const stepData = {
  ...
  lists: [
    {
      title: '第1步',
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Rectangle89727.5wywzpnocg00.jpg',
      name: '面診諮詢',
      context:
        '與專科主任交談，理解客人矯正需求，深入探討隱形牙箍治療流程及期待效果。',
    },
    {
      title: '第2步',
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Rectangle78927.na1kw38hz4g.jpg',
      name: '口腔檢查',
      context: '為客人進行口腔全面檢查，評估牙齒狀態和咬合問題。',
    },
    {
      title: '第3步',
      ...
      name: '定制方案',
      context:
        '根據口腔檢查結果及客人需求，定製個人化治療方案，達到最佳矯正效果。',
    },
    {
      title: '第4步',
      ...
      name: '牙箍製作',
      context:
        '依照方案，我們與專業廠商運用現代科技定製隱形牙箍，並寄回門診醫院。',
    },
    {
      title: '第5步',
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Rectan956727.7ayu6mc7y5s0.jpg',
      name: '配戴指導',
      context:
        '隱形牙箍完成後，會教導客人正確配戴方式。除進食和刷牙外，客人需全天配戴。',
    },
    {
      title: '第6步',
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Rectang5695627.3pp1abtn4ae0.jpg',
      name: '追蹤狀況',
      context: '治療期間，客人需定期覆診，讓專科主任追蹤進度並調整計劃。',
    },
    {
      title: '第7步',
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Rectang695627.3e3udij83mg0.jpg',
      name: '療程結束',
      context:
        '當牙齒矯正達到預期效果，矯正療程便告一段落。客人需定期配戴固定器，確保牙齒保持理想位置。',
    },
  ],
}
...
const caseLists = [
  {
    img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Ellipse785203.6a7dtcro1wo0.png',
    name: 'Natalie',
    jos: '大學生',
    context:
      '未箍牙之前，每次露齒笑都好尷尬，喺學校真係唔敢識新朋友。經過年半箍牙療程，成個人自信返晒嚟，更容易識到新朋友添！',
  },
  {
    ...
    jos: '職場OL',
    context:
      '平日返工都好羨慕啲女同事個個牙齒整齊又白淨，搞到我心郁郁想箍牙。箍牙後塊面望起上嚟瘦咗，笑容都自信咗好多。',
  },
  {
    ...
    jos: '平面模特兒',
    context:
      '做Model除咗個樣要靚之外，笑容都好重要，所以我揀咗隱形牙箍療程，令我喺平日拍攝工作上笑得更上鏡自然。',
  },
]
...
const bpData = {
  ...
  lists: [
    ...
    },
    {
      title: '倒 及',
      imgUrl:
        'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Group-1556.6xop3m9cz3k0.jpg',
    },
    {
      title: '錯咬/個別反咬合',
      imgUrl:
        'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Component-39-(1).5dt9vtsy9w00.jpg',
    },
    {
      title: '牙縫過大',
      imgUrl:
        'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Component-40-(1).2l66y7enxs80.jpg',
    },
    {
      title: '開 咬',
      imgUrl:
        'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Component-41-(1).3fzvrknw66c0.jpg',
    },
    {
      title: '齒列擠擁',
      imgUrl:
        'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Component-42-(1).7f6rnufo4vk0.jpg',
    },
  ],
}
...
const advantageData = {
  ...
  lists: [
    {
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/z0x4bI.tif.48men0yif480.png',
      name: '透明無痕',
      text: '採用獨特透明設計，\n無金屬部分露出，讓笑容更自然。',
    },
    {
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Group-1575.15r621pvsabg.png',
      name: '清潔便利',
      text: '可隨時戴脫，方便清潔，\n減低口腔問題風險。',
    },
    {
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Group-1486.46ttbalb42o0.png',
      name: '舒適貼身',
      text: '採用輕薄柔軟材質，減少口腔內軟組織的摩擦，提供無比的舒適感。',
    },
    {
      img: 'https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Group-1487.52a5et9f3ts0.png',
      name: '彈性回診',
      text: '回診時間可根據專科主任的建議適度延長，可達六至八星期。',
    },
  ],
}
const differData = {
  ...
  listDatas: [
    ...
    {
      name: '材質',
      firstText: '活動自如，以塑料或樹脂製成。',
      secondText: '固定不動，以金屬或陶瓷製成。',
    },
    {
      name: '舒適度',
      firstText: '採用柔軟輕薄物料，無金屬環和鐵線，舒適度更高。',
      secondText:
        '配戴初期可能會引起不適感，如口腔潰瘍或牙齦刺激，金屬鋼箍也會對口腔軟組織造成摩擦和壓力。',
    },
    {
      name: '療程時長',
      firstText:
        '療程時長因人而異，需要一年至兩年的時間，具體取決於個人的牙齒情況。',
      secondText: '需要一年半或更長的時間才能達到理想的矯正效果。',
    },
    {
      name: '回診時間',
      isArrayType: true,
      firstText: '通常每兩至三個月回診一次，以檢查矯正進度並更換新牙套。',
      secondText: '回診頻率較高，通常每一個月需回診進行調整。',
    },
    {
      name: '優點',
      firstText: '外觀隱蔽，不易被察覺，可自行除戴，方便清潔口腔。',
      secondText: '矯正效果更佳，適用於各種牙齒狀況。',
    },
  ],
}
      ...
      <template #xxxxxxxxxxx-home>
        <div class="banner-in-box">
          <div class="banner-content" style="display: flex">
            ...
            <div class="content-title">隱形矯正</div>
            <div class="content-remark">綻放自信笑容,煥發魅力光采</div>
            <div class="content-price">
              <div>即減</div>
              <div class="price-style">
                <img src="../../assets/images/2025011014364501.svg" alt="" />
              </div>
              <div></div>
            </div>
          </div>
    ...
    <div class="pageIn whitebgColor">
      ...
      <div class="bp">
        ...
        <div class="bp-lists">
          <div
            class="bp-lists-in"
            v-for="(bpItem, bpIndex) in bpData.lists"
            :key="bpIndex"
          >
      ...
      <div class="note">
        ...
        <div class="note-content">
          <div class="note-content-l">
            <img
              src="https://raw.gitmirror.com/CMER-SZ/picx-images-hosting/master/ckjhk/Vect9854or.4p92fvd4t4e0.jpg"
              alt=""
            />
          </div>
  ...
  &-lists {
    ...
    &-in {
      ...
      & > div {
        ...
        &:nth-of-type(2) {
          width: calc((715 / 1251) * 100%);
          margin-left: 2.5px;
          padding: 0 calc((93 / 1251) * 100%);
        }
        &:nth-of-type(3) {
          width: calc((409 / 1251) * 100%);
          margin-left: 2.5px;
          padding: 0 calc((53 / 1251) * 100%);
      ...
      &-in {
        ...
        &-title {
          ...
          &::after {
            ...
            border-left: 0.4167vw solid;
            border-right: 0.4167vw solid;
