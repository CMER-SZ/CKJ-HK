  ...
  meta: [
    {
      ...
      name: 'description',
      content:
        '愛康健擁有強大的牙科醫生團隊，牙科醫生分布在不同地區，包括羅湖區牙科醫生團隊、福田區牙科醫生團隊、南山區牙科醫生團隊、寶安區牙科醫生團隊及龍華區牙科醫生團隊。我們的牙科醫生團隊具有豐富的口腔全科診療經驗，為客人提供安全可靠的牙科服務，由一般口腔檢查服務、到美容牙科服務至高階牙科服務。',
    },
    {
      hid: 'Keywords',
      name: 'Keywords',
      content:
        '牙科團隊 牙科醫生 牙科服務 牙科護理 牙科醫生團隊 羅湖牙科醫生 福田牙科醫生 南山牙科醫生 寶安牙科醫生 龍華牙科醫生 深圳牙科醫生 深圳牙科團隊 深圳牙科服務 愛康健 深圳愛康健 深圳專業牙科中心 愛康健醫院 愛康健口腔醫院 深圳愛康健口腔醫院愛康健 CKJ愛康健齒科集團 深圳口腔專科醫院 愛康健齒科集團 深圳牙科醫院牙科服務內地牙科 深圳口腔專科',
    },
  ],
})
let doctorObjs = {
...
const headerConfig = {
  img: 'https://static.cmereye.com/imgs/2024/06/cf7029ad23e91361.jpg',
  bg: '',
...
const changleDoctorLists: any = () => {
  return (
    doctorLists_hk[appState.areaTabCurNum].filter((temp: any) => {
      return temp.dentalProfessionId.includes(dentalProfessionCur.value)
    }) || []
  )
}
...
const handletab2 = (id: string) => {
  ...
  doctorCur.value =
    changleDoctorLists().length > 0 ? changleDoctorLists()[0].id : ''
}
...
const changeDentalProfessionList = () => {
  ...
  if (doctorLists_hk[appState.areaTabCurNum].length > 0) {
    for (var i = 0; i < doctorLists_hk[appState.areaTabCurNum].length; i++) {
      _lists = [
        ..._lists,
        ...doctorLists_hk[appState.areaTabCurNum][i].dentalProfessionId,
      ]
...
onMounted(() => {
  if (route.query.did) {
    let _obj = doctorLists.value[appState.areaTabCurNum].find(
      (item: any) => item.id === route.query.did
    )
    if (_obj) {
  ...
  if (appState.areaTabCurNum) {
    changeAreaTabCur(appState.areaTabCurNum)
  }
})
    ...
    <div class="doctorPage">
      <div class="doctorPage-in smallPageCon">
        ...
        <div class="doctorPage-in-content">
          ...
          ><span>{{ $t('pages.medical_team.content.span_2') }}</span>
        </div>
        <div class="index-doctorTeam" ref="doctorTeam">
          ...
          <div>
            <section
              v-for="doctorItem in changleDoctorLists()"
              :key="doctorItem.id"
            >
              <div
        ...
        &-r {
          ...
          .detail-6 {
            ...
            span {
              ...
              border-radius: 50px;
              padding: 10px 30px;
              box-shadow: 0 5px 10px var(--indexColor3);
              transition: all 0.3s;
              &:hover {
                opacity: 0.7;
              }
          ...
          &-r {
            ...
            .detail-6 {
              ...
              span {
                ...
                box-shadow: 0 0.2604vw 0.5208vw var(--indexColor3);
              }
            }
          }
        }
