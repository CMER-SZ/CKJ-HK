...
useHead({
  ...
  meta: [
    ...
    },
    {
      ...
      content: () => {
        return (
          'https://www.ckjhk.com/news/news-information/' +
    ...
    },
    {
      property: 'og:image',
      content: () => {
        return coverageDeatail.value.videos === ''
          ? coverageDeatail.value.videos
          : coverageDeatail.value.img
      },
    },
  ],
})
    ...
    <div class="pageIn whitebgColor articlePage">
      ...
      <div class="articlePage-in" v-if="!errorpage" v-loading="pageLoading">
        ...
        <div
          class="content-topimg"
          v-else-if="
            coverageDeatail.videos === '' && coverageDeatail.pics.length
          "
        >
          ...
          <div class="content-bdetail-in">
            <div class="context">
              ...
              <div class="righeBox">
                ...
                <a
                  :href="`https://www.facebook.com/sharer/sharer.php?u=https://www.ckjhk.com/news/news-information/${_nid}`"
                  target="_block"
                  class="facebook"
                  title="分享facebook"
                ></a>
