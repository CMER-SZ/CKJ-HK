...
const pageDetail: any = {
  ...
  content: [
    ...
    //       type: 'pbeford',
    //       before: '1.',
    //       text: '會員可撥打預約專線，經過專員初步認證後預約相應門診醫院應診。',
    //     },
    //     {
    //       type: 'pbeford',
    //       before: '2.',
    ...
    },
    {
      type: 'ul',
      list: [
        '此會員優惠必須出示有效工聯會會員卡及會員卡本人使用，不得轉讓',
        '此會員優惠不可兌回現金，不可與其他優惠同時使用',
        '此優惠服務需提前進行預約，而且可能會受到可預約時間限制',
        '如要更改或取消預約，請提前48小時通知香港客服以作時間調整安排',
        '最終決定權: 如有任何爭議，深圳希瑪愛康健口腔集團將會保留最後之決定權',
      ],
    },
  ],
}
      ...
      <div class="content">
        ...
        <div class="pbeford">
          <section>
            ...
            <section>
              <section>
                <p class="pbeford"><span>1.</span><span>會員可撥打預約專線，經過專員初步認證後預約相應門診醫院應診。</span></p>
              </section>
            </section>
            <section>
              <section>
                <p class="pbeford"><span>2.</span><span>亦可透過Whatsapp留言預約，專員見到留言後會盡快聯絡進行認證和預約。</span></p>
              </section>
            </section>
            <section>
              <section>
                <p class="pbeford"><span>3.</span><span>預約前一天，會透過SMS提醒會員應診。</span></p>
              </section>
            </section>
            <section>
              <section>
                <p class="pbeford">
                  <span>4.</span><span>會員到診時，需出示工聯卡實體卡、工聯App內的電子卡、工人俱樂部實體證或工聯App內的電子證明以進行正式認證並享受優惠。</span>
                </p>
              </section>
            </section>
            </p>
        ...
        <div v-for="(item, index) in pageDetail.content" :key="index" :class="item.className || ''">
          ...
          <section v-else-if="item.type === 'h4'">
            <h4>{{ item.text }}</h4>
          </section>
        ...
        <section>
          <div class="animBtn">
            <PageAnimBtnTypeTwo link="https://www.ftu.org.hk/zh-hant/" str="香港工會聯合會官網" />
          </div>
        </section>
        <!-- <div class="btn">
