  ...
  <div>
    ...
    <div class="privacyPolicy">
      ...
      <div class="privacyPolicy-context">
        <p>
          以下是深圳愛康健口腔醫院與其附屬公司根據《個人資料(私隱)條例》(第486章)之規定所訂之私隱政策聲明。我們將確保我們之職員將執行有關政策，嚴格保密你的個人資料。
        </p>
        ...
        <p>
          惟在法律准許的情況下，深圳愛康健口腔醫院不會負責任何因以下情況而引致的損失、損毀或責任（不論直接或間接產生），包括但不限於收入、利潤或信譽的損失：(1)
          任何因電腦、網路、電話、技術或系統的不正常運作或其他問題，包括由電腦系統病毒感染、缺陷、篡改、未經授權的干擾、欺詐、技術故障或其他超出了深圳愛康健口腔醫院的控制範圍的任何原因；(2)
          任何由第三者所提供的服務的缺乏或不足之處；(3)
          任何因資料傳送上的錯誤而導致通知的誤傳、延誤、更改或遺失。
          客戶亦需確保所有登記資料均為真實、準確及完整的資料，以及沒有冒用或盜用任何第三者之資料。如客戶因冒用或盜用任何第三者之資料而引致深圳愛康健口腔醫院或其他第三者有任何損害，客戶須負上一切相關損失、損毀或責任，並對深圳愛康健口腔醫院或其他第三者因此所承受的任何損害作出彌償及使其免於損害。
        </p>
        ...
        <p>
          用戶如對我們之私隱政策及慣例有任何疑問，請電郵info@ckjhk.com致深圳愛康健口腔醫院市場部。
        </p>

        <p>如有任何爭議，深圳愛康健口腔醫院保留最終決定權​。</p>
      </div>
