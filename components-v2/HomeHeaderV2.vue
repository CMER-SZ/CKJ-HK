...
<template>
  <header>
    <div class="header-content">
      <!-- pc菜单 -->
      <div :class="[
        isFiexdHeader ? 'headerBox02' : 'headerBox02',
        'pcMenuBox',
          ...
          <div class="container-fluid position-relative">
              ...
              <div class="header-appointment d-flex align-items-center">
                <a href="https://wa.me/85269338128?text=Hello愛康健,我想查詢牙科服務" target="_blank"><svg
                    ...
                    <path
                      ...
                      fill="white" />
                  </svg> </a><nuxt-link to="#contactUsFormNav"><svg width="43" height="43" viewBox="0 0 43 43"
            ...
            <div class="offcanvas offcanvas-end d-lg-none" tabindex="-1" id="offcanvasNavbar"
              ...
              <div class="offcanvas-header">
                <nuxt-link to="/" class="offcanvas-title" id="offcanvasNavbarLabel"><img
                    src="@/assets/images/LOGO-PC.svg" alt="" /> </nuxt-link><button type="button"
                  class="btn-close text-reset offcanvas-btn" data-bs-dismiss="offcanvas" aria-label="Close"></button>
              </div>
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1" id="accordionMenu">
                      ...
                      <ul class="navbar-nav">
                        <li class="nav-item">
                          <nuxt-link class="nav-link" to="/brand/course#course">{{
                            $t(
                              'components.header.menuLists.menu_brand.history'
                            )
                          }}</nuxt-link>
                        </li>
                        <li class="nav-item">
                          <nuxt-link class="nav-link" to="/brand/course#activity">{{
                            $t(
                              'components.header.menuLists.menu_brand.activity'
                            )
                          }}</nuxt-link>
                        </li>
                        <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <div class="nav-link d-flex justify-content-between" data-bs-toggle="collapse"
                      data-bs-target="#collapseExample2" aria-expanded="false">{{
                        $t(
                          'components.header.menuLists.menu_dental_service.name'
                        )
                      }}</div>
                  ...
                  <li class="nav-item">
                    <nuxt-link to="/health-care-voucher" class="nav-link d-flex justify-content-between">{{
                      $t(
                        'components.header.menuLists.health-care-voucher.name'
                      )
                    }}</nuxt-link>
                  </li>
                  <li class="nav-item">
                      ...
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <nuxt-link class="nav-link" to="/news/information">{{
                            $t(
                              'components.header.menuLists.menu_news.information'
                            )
                          }}</nuxt-link>
                        </li>
                        <li class="nav-item">
                          <nuxt-link class="nav-link" to="/news/tooth-wiki">{{
                            $t(
                              'components.header.menuLists.menu_news.tooth-wiki'
                            )
                          }}</nuxt-link>
                        </li>
                      </ul>
                      ...
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <nuxt-link class="nav-link" to="/contactUs#appeal">{{
                            $t(
                              'components.header.menuLists.menu_contactUs.appeal'
                            )
                          }}</nuxt-link>
                        </li>
                        <li class="nav-item">
...
.header-content {
  ...
  .headerBox02 {
    ...
    .pc_menu_tel {
      ...
      padding: clamp(15px, 1.0465vw, 20px) clamp(20px, 3.0465vw, 60px) clamp(15px, 1.0465vw, 20px) clamp(15px, 1.0465vw, 20px);
      color: #fff;
      text-align: center;
...
@media (max-width: 991.98px) {
  ...
  .offcanvas-end .offcanvas-body .navbar-nav .nav-item .nav-link[aria-expanded='true'] {
  ...
  .offcanvas-end .offcanvas-body .navbar-nav .nav-item .secondaryMenu .navbar-nav .nav-item .nav-link {
    color: var(--White, #fff);
    font-family: 'Noto Sans HK';
    font-size: 16px;
    font-style: normal;
