    ...
    <div class="header-content">
      ...
      >
        <a class="a-header-content-in" href="#contactUsFormNav"
          ><i style="color: red; font-style: normal">❤</i> 感恩愛牙節 🦷
          進口種植牙 ¥3689/顆 起❗</a
        >
          ...
          <div class="container-fluid position-relative">
            ...
            <div class="collapse navbar-collapse d-lg-block" id="navbarNav">
              <ul class="navbar-nav ms-auto d-flex align-items-center">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="accessibilityWidget" tabindex="0"
                    ><svg
                ...
                <li class="nav-item">
                  <div class="nav-link">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M8.89 25.91H4.25V21.01"
                        stroke="#333333"
                        stroke-miterlimit="10"
                      />
                      <path
                        d="M8.59998 24.9099L10.33 25.9099L8.59998 26.8999V24.9099Z"
                        fill="#333333"
                      />
                      <path
                        d="M15.2999 11.5H19.9399V16.4"
                        stroke="#333333"
                        stroke-miterlimit="10"
                      />
                      <path
                        d="M15.59 12.5L13.86 11.5L15.59 10.5V12.5Z"
                        fill="#333333"
                      />
                    </svg>
                  </div>
